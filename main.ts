...
game.splash(game.askForString(game.ask("whats You Name")))
...
let House2 = sprites.create(img`
    ...
    `, SpriteKind.HOuse)
tiles.placeOnRandomTile(House2, sprites.builtin.forestTiles0)
let HOuse4 = sprites.create(img`
    ...
    `, SpriteKind.HOuse)
tiles.placeOnRandomTile(HOuse4, sprites.castle.tileGrass2)
let House3 = sprites.create(img`
    ...
    ......bcccbbbcbbe3b33b33b33b33bebbcbbbcccb......
    `, SpriteKind.HOuse)
tiles.placeOnRandomTile(House3, sprites.builtin.forestTiles10)
let House5 = sprites.create(img`
    ...
    ......bcccbbbcbbe3b33b33b33b33bebbcbbbcccb......
    `, SpriteKind.HOuse)
tiles.placeOnRandomTile(House5, sprites.builtin.forestTiles12)
